  ...
  async generateJson(prompt) {
    ...
    if (prompt.includes("共同回忆编辑和视觉导演")) {
      ...
      return {
        ...
        imagePrompt: revised ? "Square hand-painted gouache memory of Jerry walking on a street after rain, visible brush texture, no pets, no text." : "Square hand-painted gouache memory of Jerry taking an evening walk, visible brush texture, no pets, no text.",
