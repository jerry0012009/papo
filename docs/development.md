...
- Home's latest-result surface defaults to Papo's final reply only. Curious selected/ignored reasoning and attention details stay inside an expandable "what Papo noticed" detail so Home feels like a living presence, not an analysis report.
